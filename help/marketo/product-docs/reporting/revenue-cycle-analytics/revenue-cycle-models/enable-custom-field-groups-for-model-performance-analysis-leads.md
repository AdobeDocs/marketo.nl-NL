...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1" rowspan="1"><p>De aangepaste veldgroep is ingeschakeld voor rapportage in het gebied Modelprestatieanalyse (Leads)</p></td> 
   <td colspan="1" rowspan="1"><p>Het douanegebied zelf wordt toegelaten voor rapportering in de Gebieden van de Analyse van de Lood, van de Analyse van de Campagne, en van de Analyse van de Kans.</p><p><strong>NOTA:De de gebiedsgroepen van de </strong> Douane worden NIET gesteund op deze analysegebieden, zodat tonen de groepsverenigingen niet in de Ontdekkingsreiziger van de Cyclus van de Opbrengst-<em></em> slechts het douanegebied.</p></td> 
  </tr> 
 </tbody> 
</table>
...
1. Klik **Geen** naast een lege veldgroep. Als u al drie veldgroepen hebt ingeschakeld en u wilt bewerken, klikt u op de naam van de veldgroep die u wilt wijzigen.

   ![](assets/three.png)

1. Klik op het vervolgkeuzemenu **Veld** en selecteer het gewenste veld.
