...
Leer hoe u uw pagina-uitgiftegegevens exporteert naar een CSV-bestand als u deze gegevens wilt delen met personen buiten Marketo.
...
1. Klik op de pagina waarvoor u details wilt zien.
   ...
   De boor Omlaag van het Detail van de Pagina verschijnt. **[!UICONTROL Page Optimization Results]** is een lijst van alle kwesties met die bepaalde pagina.
