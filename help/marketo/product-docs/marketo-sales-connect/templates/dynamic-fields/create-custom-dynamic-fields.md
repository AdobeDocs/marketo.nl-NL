...
## Aangepaste velden opslaan voor een of enkele contactpersonen {#saving-custom-fields-for-one-or-a-few-contacts}

1. Klik op de naam van een contactpersoon op de pagina Personen.
1. Kies de vervolgkeuzelijst naast Unsubscribe en selecteer **Edit**.
...
1. Volg [normaal CSV uploadproces](http://docs.marketo.com/x/HIPS), die op het scherm van de gebiedstoewijzing tegenhouden.
1. Kies **Een nieuw aangepast veld toevoegen** in de vervolgkeuzelijst in plaats van een van de vooraf ingestelde velden.
...
## Uw aangepaste velden gebruiken in een sjabloon {#how-to-use-your-custom-fields-in-a-template}

Zodra uw aangepaste velden zijn opgeslagen met de bovenstaande methoden, kunt u ernaar verwijzen in uw sjablonen.

1. [Maak een sjabloon ](http://docs.marketo.com/x/OCDG) en klik op de knop  **Dynamische** velden, zoals u dat normaal zou doen.
1. Selecteer **Aangepaste velden** in de vervolgkeuzelijst die wordt weergegeven.
