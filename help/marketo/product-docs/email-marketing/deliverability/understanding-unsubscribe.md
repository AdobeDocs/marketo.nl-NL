...
description: Meer informatie over afmeldingstypen in Marketo (Afmelden, Marketing opgeschort, Op de lijst met ongewenste personen staan). Gebruik het juiste gebied voor elk scenario in uw campagnes.
