...
1. In de **[!UICONTROL IP Restrictions]** gebied, klikken **[!UICONTROL Edit],** of klik op **[!UICONTROL Edit IP Restrictions]** linksboven.

   ![](assets/create-an-allowlist-for-ip-based-api-access-3.png)

1. Controleer de **[!UICONTROL Enable IP Restrictions]** en ga de IP adressen in u Lijst van gewenste personen wilt.
...
1. Klikken **[!UICONTROL Add]** om extra gebieden te openen om meer IP adressen in te gaan.
