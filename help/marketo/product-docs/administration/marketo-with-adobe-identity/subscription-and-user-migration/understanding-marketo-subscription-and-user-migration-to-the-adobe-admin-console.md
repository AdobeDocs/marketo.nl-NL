---
description: Wat verandert wanneer abonnementen en gebruikers aan de Adobe Admin Console, met inbegrip van de rollen van Admin van het Systeem en van het Product, login met de Identiteit van Adobe, URLs, en de migratiechronologie migreren.
