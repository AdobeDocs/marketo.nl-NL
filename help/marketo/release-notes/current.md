...
# Opmerkingen bij de release: oktober 2023 {#release-notes-oct-23}

Hieronder vindt u alle functies die zijn inbegrepen in de release van 23 oktober. Raadpleeg de Adobe Marketo Engage-editie voor informatie over de beschikbaarheid van functies.
...
<table style="table-layout:auto"> 
 <tbody> 
  ...
  <tr> 
   ...
   <tr> 
   <td><strong>Opname downloaden en cohost toewijzen in interactieve webinars</strong>: U kunt nu een externe cohost voor uw webinar toevoegen als de oorspronkelijke host niet beschikbaar is. U kunt nu ook de webinar-opname downloaden.</td> 
   <td>Verzonden</td>
