---
description: Leer hoe u e-mailberichten kunt maken, personaliseren en bekijken in de e-mailtoepassing van de Designer. Gebruik Design Studio- of e-mailprogramma's om e-mails van auteurs te maken.
title: E-mailontwerp
...
1. In de boom, uitgezochte **E-mail (Nieuw)**.
...
1. In e-mail u enkel creeerde, klik **e-mailinhoud** uitgeven.
...
1. U kunt kiezen tussen een thema als uitgangspunt (aanbevolen) of een geheel nieuw gebouw met handmatige opmaak.

   >[!NOTE]
   >
   >E-mails die met handmatige opmaak zijn gemaakt, kunnen geen fragmenten gebruiken die met thema&#39;s zijn gemaakt
