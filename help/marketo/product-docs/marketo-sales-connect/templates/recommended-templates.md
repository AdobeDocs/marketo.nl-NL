...
description: Lees meer over aanbevolen sjablonen in Sales Connect. Zie welke sjablonen de beste service krijgen en deze gebruiken voor outreach.
...
Met de aanbevolen sjablonen van [!DNL Sales Connect] krijgt u het juiste bericht en bespaart u tijd. Dit geeft u meer stroom bij het verzenden van e-mails en vermindert de onzekerheid bij het zoeken naar de juiste e-mail voor de juiste persoon.

1. Ga naar de tab [!UICONTROL Templates] .

1. Selecteer het malplaatje u zou willen adviseren en **klikken geeft** uit.

1. De functie Aanbevolen sjabloon inschakelen voor de sjablooncontrole **[!UICONTROL Auto-Suggest this template when]** .

## Alle vs. alle {#all-vs-any}

Het is nu tijd om de criteria te selecteren. Selecteer **[!UICONTROL All]** als u wilt dat de sjabloon wordt aanbevolen als aan alle criteria wordt voldaan. Selecteer **[!UICONTROL Any]** als u wilt dat de sjabloon wordt aanbevolen wanneer aan een van de criteria wordt voldaan.
...
Sla de sjabloon op nu de criteria zijn ingesteld. Vanaf hier werkt [!DNL Sales Connect] aan zijn magie om de beste sjablonen voor u te laten zien.
