---
description: Salesforce-configuratie - Marketo Docs - Productdocumentatie
title: Salesforce-configuratie
hide: true
hidefromtoc: true
...
## Salesforce-aanpassingspakket verwijderen (Classic) {#uninstall-salesforce-customization-package-classic}

Verwijder het Marketo Sales Connect-pakket van uw Salesforce-account als u het MSI-Actions-pakket gebruikt.

**Verkoop Connect-velden verwijderen uit paginalayout**
...
**Knoppen Verkoop verbinden verwijderen uit pagina-indelingen**
...
**Verkoop Connect-velden verwijderen uit sectie Activiteitenoverzicht**

1. Blader naar de onderkant van de pagina en klik op het pictogram Sleutel.

   ![](assets/salesforce-configuration-10.png)

1. Selecteer vervolgens de velden Verkoop Connect in het gebied Geselecteerde velden en klik op de pijl Verwijderen. Klikken **OK** wanneer gereed.
...
**Knoppen Handeling bulksgewijs verkopen verwijderen uit de koplijstweergave**
...
**MSC-configuratie verwijderen voor contactpersonen**
...
**MSC-configuratie voor opportunity verwijderen**
...
**MSC-configuratie voor account verwijderen**
...
**Postvak UIT Marketo-verkoop verwijderen**
...
**Sales Connect-pakket verwijderen**
...
**Aanpassingsgegevens van Sales Connect**
