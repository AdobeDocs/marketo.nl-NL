---
description: Leer hoe u reCAPTCHA v3 instelt voor Marketo-formulieren. Vorm onzichtbare reCAPTCHA om spam te bestrijden zonder gebruikers te blokkeren.
...
ReCAPTCHA v3 is een frictioneloze ervaring die formulierverzendingen scoort op basis van hoe verdacht ze zijn zonder tekst, afbeeldingen of knopuitdagingen te gebruiken. [Meer info](https://developers.google.com/search/blog/2018/10/introducing-recaptcha-v3-new-way-to){target="_blank"}.
