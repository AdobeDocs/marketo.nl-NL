---
description: Snelle verwijzing naar koppelingen voor het instellen van Marketo Engage met Adobe Identity, waaronder System Admin-instelling, gebruikersbeheer, gebruikers met alleen API en aanmelden.
title: Snelle gids
...
[&#x200B; voeg een Admin van het Product toe &#x200B;](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-product-admin.md#add-a-product-admin){target="_blank"}
...
[&#x200B; voeg een Gebruiker &#x200B;](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md#add-a-user){target="_blank"} toe

[&#x200B; verwijder een Gebruiker &#x200B;](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md#remove-a-user){target="_blank"}
...
[&#x200B; voeg slechts Gebruiker API voor de Ingeschakelde Abonnementen van Adobe IMS toe &#x200B;](/help/marketo/product-docs/administration/users-and-roles/create-api-only-user.md){target="_blank"}
