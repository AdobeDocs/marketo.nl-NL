...
### Beheer van marktleider {#marketo-lead-management}
...
* **Integratie** van Data.com: Verrijk uw gegevens met Data.com gebruikend een nieuwe Marketo stroomactie.
* **Sociaal delen van bestemmingspagina**&#39;s: U kunt gemakkelijk knoppen voor sociaal delen toevoegen en configureren op uw e-mails, zoals Facebook, Twitter, LinkedIn en Google+.
* **Ondersteuning voor** native opportunity: Vooral handig voor klanten die Salesforce niet als hun CRM gebruiken, hebben we een set nieuwe API&#39;s uitgebracht voor het uitvoeren van de bewerkingen Maken, Lezen, Bijwerken en Verwijderen (CRUD) op het Opportunity-object binnen Marketo.
* **Filters** voor programmaprestaties: Filter het prestatierapport van het programma op markeringen en kanalen, om uw programma&#39;s van de Marketo voor rapportering te groeperen en te vergelijken.
...
### Beheer van marktleider {#marketo-lead-management-1}
...
### Beheer van marktleider {#marketo-lead-management-2}
...
### Marktverkoopoverzicht {#marketo-sales-insight}
...
* **Padanalyse** met succes: Voor klanten van de Ontdekkingsreiziger van de Ontvangingscyclus, controleer uw modelprestaties van binnen het Beheer van de Lood van de Marketo.

## november 2010 {#november}

* **Afbeeldingen en bestanden** vervangen: Bestanden bijwerken die u al hebt geüpload naar Marketo!
...
* **ICS-bestanden uploaden**: Browsers verwerken het downloaden van ICS-bestanden van Marketo op de juiste wijze.
...
* **SOAP API-configuratie**: Krijg uw montages van de ZEEP API door de Marketo interface.
