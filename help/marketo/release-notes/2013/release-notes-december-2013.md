...
De volgende functies zijn opgenomen in de release van december. Controleer [Marketo Edition](http://docs.marketo.com/display/docs/assets/pricing.php) op beschikbaarheid van functies.
...
We zijn begonnen onze creatieve flair in de toepassing uit te drukken. Elk kwartaal wordt er een nieuwe kunstenaar weergegeven. Om ons weg te schoppen, selecteerden wij [Trey Ratcliff](http://stuckincustoms.smugmug.com/).
