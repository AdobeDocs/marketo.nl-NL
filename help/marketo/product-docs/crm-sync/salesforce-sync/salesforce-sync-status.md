---
description: Meer informatie over het Salesforce Sync Status dashboard en over het weergeven van synchronisatiestatussen. Filteren op datum, bewerkingstype of objecttype en synchronisatiefouten exporteren als CSV.
