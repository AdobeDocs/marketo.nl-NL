...
<table>
 <tbody>
  ...
  <tr>
   ...
   <p>
   <li>Hoeveel gebruikers zijn er?</li>
<li>Zijn er om het even welke gebruikers die <a href="/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md#remove-a-user" target="_blank"> zouden moeten worden verwijderd </a>?</li>
...
<p><img src="assets/note-icon.png" alt="notitiepictogram"> OPMERKING: neem contact op met de ondersteuning van Adobe om Aangepaste synchronisatiefilters te identificeren of om een aangepaste synchronisatieregel te vragen.</li></td>
  </tr>
  <tr>
