...
description: Leer hoe u zelfweergaven kunt voorkomen in Sales Connect. Tel uw eigen e-mails niet mee wanneer u deze bekijkt of test.
...
[!DNL Sales Connect] slaat een cookie op in uw browser om te voorkomen dat weergaven worden bijgehouden wanneer u uw e-mails opent vanuit Outlook Web App en Gmail. Als u nog zelfmeningen ontvangt, adviseren wij het volgende te doen:
...
1. Klik in [!DNL Outlook] op **[!UICONTROL File]** in de menubalk.
...
1. Klik onder [!UICONTROL Microsoft Outlook Trust Center] op **[!UICONTROL Trust Center Settings]** .
