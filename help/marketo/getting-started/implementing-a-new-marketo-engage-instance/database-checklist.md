...
<tbody>
  ...
  <tr>
    ...
    <li>Controleer de personen in de categorie 'Ongeldig e-mailadres' en bepaal of hun e-mails nodig zijn <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/email-marketing/deliverability/hard-and-soft-bounces-in-email.html" target="_blank">handmatig opnieuw instellen</a>.</li></td>
  </tr>
  <tr>
