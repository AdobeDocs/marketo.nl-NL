...
description: Exporteer de optimalisatieproblemen van de pagina naar een CSV-bestand vanaf de pagina tot aan de pagina om deze buiten Marketo te delen.
...
U kunt de gegevens van uw pagina-uitgave exporteren naar een CSV-bestand als u die gegevens wilt delen met personen buiten Marketo. Zo gaat het.
...
1. Klik op de pagina waarvoor u details wilt zien.
   ...
   Dit is de boor neer van het Detail van de Pagina. **[!UICONTROL Page Optimization Results]** is een lijst van alle kwesties met die bepaalde pagina.
