...
* **Verbeterde ****Geolocatie**: We verzamelen nu aanvullende gegevens die u helpen uw leads te identificeren, zoals de gevolgde plaats, staat/regio, postcode, code van het telefoongebied en het metrogebied.
...
* **Lijst van afgewezen personen en afzet Uitgestelde controle**: Nu kunt u de e-mailstromen beheren op basis van welke criteria u ook wilt.
...
* **Op populair verzoek hebben we nieuwe e-mailkolommen toegevoegd aan de sectie** Analytics: Het e-maildiagram geeft nu meer details weer, zoals tellingen voor verzonden, teruggestuurd, leveringspercentage en niet-geabonneerd. Op het tabblad **Campagneoverzicht wordt niet langer het overzicht** van de e-mailprestaties weergegeven: Er is nu een tabblad E-mail beschikbaar om deze informatie weer te geven. Dit verslag is ook per campagne beschikbaar.
...
* **Exporteer vanuit een** lijst, een slimme lijst en zelfs uit de activiteitenresultaten van een campagne. Kijk alleen maar naar de onderkant van het raster en klik op Exporteren.
...
* **De verbeteringen** van de snelheid op kokensmanuscript en verscheidene categorieën slimme lijsten en onderzoeken.
* **Slepen en neerzetten** werkt nu ook als u het pictogram vastgrijpt. Ik weet dat dit vervelend was. Alles opgelost!
* **Meer gehoste jQuery-plug-ins** voor gebruik op bestemmingspagina&#39;s. Alle soorten dynamische mogelijkheden zijn beschikbaar bij het openen van pagina&#39;s met aangepaste HTML. Vraag ons vandaag om hulp. We zullen binnenkort &#39;Hoe kan ik?&#39; publiceren. Enkele mogelijkheden:
...
* Lead DB &quot;**Snel zoeken**&quot; zoekt nu naar naam, functie, bedrijf en e-mailadres. Werkt ook met paginering.
...
* **Grote optimalisaties** van de prestaties overal.
...
* Tegels met **opgeloste problemen**.
...
* Veel **foutoplossingen**

### Volgende: {#whats-next}

* [Opmerkingen bij de release van Marketo 2010-2011](2010-2011.md)
