...
+ Productdocumenten {#product-docs}
   ...
   + Beheer {#administration}
      + {#setup} instellen
         ...
         + [Algemene regel voor formuliervalidatie](product-docs/administration/setup-administration/global-form-validation-rule.md)
   ...
   + Demand Generation {#demand-generation}
      ...
      + Dynamisch chat {#dynamic-chat}
         ...
         + [Dynamische chat openen](product-docs/demand-generation/dynamic-chat/access-dynamic-chat.md)
...
+ Opmerkingen bij de release {#release-notes}
   ...
   + Eerdere versies {#previous-releases}
      ...
      + 2020 {#2020}
         ...
         + [Opmerkingen bij de release: 20 juni](release-notes/previous-releases/2020/release-notes-june-20.md)
         + [Opmerkingen bij de release: 20 juli](release-notes/previous-releases/2020/release-notes-july-20.md)
         + [Opmerkingen bij de release: 20 okt.](release-notes/previous-releases/2020/release-notes-oct-20.md)
      + 2019 {#2019}
         + [Opmerkingen bij de release: 19 augustus](release-notes/previous-releases/2019/release-notes-august-19.md)
