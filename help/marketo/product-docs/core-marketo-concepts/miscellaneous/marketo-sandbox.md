...
* Als u wenst om gebruikers toe te voegen, is het proces het zelfde als [ toevoegend gebruikers in productie ](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user#add-a-user). Ze moeten opnieuw een ander e-mailadres gebruiken als ze al een Marketo-aanmelding hebben.
