...
1. Klik op **[!UICONTROL 5 minutes]** (dit is de standaardkop).
...
1. Voer een tijd in met minuten. Klik op **[!UICONTROL Save]**.
   ...
   >[!NOTE]
   >
   >Eén statische weergave weergeven door **[!UICONTROL Disable Rotation]** te controleren.
...
1. Selecteer de vervolgkeuzelijst **[!UICONTROL Calendar Display]** en kies tussen **[!UICONTROL 3 weeks]** of één **[!UICONTROL Month]** .
