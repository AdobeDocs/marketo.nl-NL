...
description: Leer hoe Marketo- en Salesforce-gegevens gesynchroniseerd blijven door de Salesforce-synchronisatie. Zie wat wordt gesynchroniseerd en hoe tweerichtingssynchronisatie werkt voor leads en contacten.
