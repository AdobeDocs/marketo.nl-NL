...
description: Stappen voor het maken van aangepaste Marketo-objecten voor een-op-veel- of veel-op-veel-structuren, zoals de weergavenaam, de API-naam en Tonen in Lead Detail.
