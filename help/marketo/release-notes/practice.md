---
description: Opmerkingen bij de Praktijkrelease - Marketo Docs - Productdocumentatie
title: Opmerkingen bij de Praktijkrelease
hide: true
hidefromtoc: true
...
De volgende functies worden vrijgegeven op **14 oktober 2022**, met een gefaseerde uitrol van de resterende kenmerken in de daaropvolgende weken (tenzij anders vermeld). De versiefuncties en de exacte datums kunnen worden gewijzigd.
...
* **Rollen en machtigingen voor dynamische chat**: Beheerders kunnen korrelige machtigingen gebruiken om de zichtbaarheid en het gebruik van de toepassing te beheren en aangepaste gebruikersrollen te maken.

   * Volledige toegang - gebruikers kunnen ten volle gebruikmaken van de functie (bijvoorbeeld dialoogvensters publiceren, kleurschema wijzigen, enz.)
   * Alleen-lezen toegang - gebruikers kunnen informatie zien, maar kunnen geen wijzigingen aanbrengen (zie bijvoorbeeld Audience Criteria of Stream Designer, maar niet wijzigen)
   * Beperkte toegang - gebruikers kunnen de secties van de Configuratie of van de Integratie niet zien of toegang hebben
