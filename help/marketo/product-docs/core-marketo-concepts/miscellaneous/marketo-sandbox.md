...
description: Leer hoe u de Marketo Engage-sandbox kunt testen voordat u gaat produceren. Gebruik een sandbox-instantie om te testen zonder de productie te beïnvloeden.
...
* Als u wenst om gebruikers toe te voegen, is het proces het zelfde als [&#x200B; toevoegend gebruikers in productie &#x200B;](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md#add-a-user). Ze moeten opnieuw een ander e-mailadres gebruiken als ze al een Marketo-aanmelding hebben.
