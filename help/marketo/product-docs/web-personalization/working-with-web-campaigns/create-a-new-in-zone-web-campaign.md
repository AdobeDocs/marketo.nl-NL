...
description: Maak webcampagnes in zone die website-elementen op basis van zone-id vervangen door gepersonaliseerde inhoud of grafische banners. Gebruik zone-id's om specifieke gebieden van uw website als doel in te stellen.
