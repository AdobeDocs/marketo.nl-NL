...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td>Vrijgegeven</td>
   <td><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/email-designer/ai-assistant#create-content-for-a-specific-section">Inhoud maken voor een specifieke sectie van uw e-mail</a></td>
  </tr>
  </tbody>
</table>
<br/>
