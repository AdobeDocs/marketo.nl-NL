...
>[!NOTE]
>
>Tijdzone voor ontvangers werkt momenteel **alleen** met e-mailinhoud. Het werkt niet voor standaardserviceprogramma&#39;s.
...
Om elke tijdzone aan te kunnen, beginnen de e-mailprogramma&#39;s die met Ontvankelijke Tijdzone worden gepland om middernacht in de **eerste/vroegste** tijdzone in de wereld (UTC +14:00) te lopen.

## Betrokkenheidsprogramma&#39;s {#engagement-programs}

Wanneer u een stroom [van het betrokkenheidsprogramma](../../../../../product-docs/email-marketing/drip-nurturing/engagement-program-streams/set-stream-cadence/schedule-engagement-programs-with-recipient-time-zone.md) plant en de Ontvankelijke Tijdzone actief is, begint de programmagietvorm om middernacht in UTC +14:00 te lopen. Wij vereisen u om de eerste gietvorm minstens 25 uren in de toekomst (24 uren + wat tijd te plannen om de campagne te beginnen) te plannen omdat de mensen voor de gietvorm in elke tijdzone over de wereld kunnen kwalificeren. Beginnen met verwerking op dit moment in UTC +14:00 garandeert dat we de e-mail op de geplande datum en tijd leveren voor elke persoon die voor deze cast in aanmerking komt.
...
In gevallen waarin **alleen **Land of **alleen** staat beschikbaar is:
...
Als we nog steeds de tijdzone van iemand van om het even welke combinatie van deze gebieden niet kunnen bepalen, zullen wij **geen** tijdzone toewijzen en e-mail zal worden geleverd gebaseerd op uw streek van de het abonnementstijd van Marketo. Dus als uw programma voor PDT 9:00am gepland is, zullen de mensen zonder toegewezen tijdzone de e-mail om PDT 9:00am ontvangen.
