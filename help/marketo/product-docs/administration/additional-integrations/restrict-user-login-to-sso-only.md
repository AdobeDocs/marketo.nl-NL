...
description: SSO vereist voor alle gebruikers, zodat deze de SSO-beveiliging niet kunnen omzeilen via de instellingen voor aanmelding bij Admin (geldt niet voor Adobe IMS).
