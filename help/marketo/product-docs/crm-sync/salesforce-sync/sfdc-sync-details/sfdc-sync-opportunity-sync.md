...
description: Leer hoe synchronisatie van mogelijkheden van Salesforce naar Marketo werkt. Zie hoe de kansen synchronisatie, associëren met contacten, en de trekkers en filters van de gebruikskans.
...
Nee, Marketo ondersteunt slechts één valuta. Het opportuniteitsbedrag zal van [!DNL Salesforce] worden gesynchroniseerd maar de munt zal de [ standaardmunt ](/help/marketo/product-docs/administration/settings/set-default-currency.md) in uw abonnement van Marketo zijn.
