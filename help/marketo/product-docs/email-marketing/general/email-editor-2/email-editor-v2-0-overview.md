...
>[!IMPORTANT]
>
>Hoewel er geen exacte datum is ingesteld, wordt de klassieke e-maileditor waarschijnlijk ergens in 2027 vervangen (we kondigen een exacte datum aan wanneer we deze hebben). Het wordt sterk geadviseerd om met goedkeuring van geavanceerde [ E-mail Designer ](/help/marketo/product-docs/email-marketing/email-designer/overview.md){target="_blank"} te beginnen, aangezien het vele mogelijkheden niet beschikbaar in de klassieke redacteur heeft.
