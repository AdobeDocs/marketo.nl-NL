...
* **Controlesom bestand uitnemen bulksgewijs**: Controleer of een volledig bestand is opgehaald door de hash van het bestand te vergelijken met de controlesom van de voltooide extractietaken.
...
>[!CAUTION]
>
>Vanaf 18 juni 2019 is e-mail 1.0 niet meer beschikbaar. Meer informatie over e-mail 2.0 en de afgekeurde e-mail 1.0 [hier](https://nation.marketo.com/docs/DOC-7038).
...
* **Caps voor gebeurtenissen** en **Gebeurtenisdoelen** zijn over het algemeen beschikbaar in Marketo Sky onder de Premium Events Add-on.
...
* **Pagina met details over afbeeldingen, bestanden en fragmenten**: Snel informatie over uw elementen ophalen met bijvoorbeeld metagegevens _gemaakt op/door_ en handelingen zoals _delete_ en _goedkeuren_.
...
* **E-mailsjablonen voor systemen**: Bijgewerkte ontwerp-, responsiviteit- en internationalisatiemogelijkheden.

## Bizible van Marketo {#bizible-by-marketo}

* **Ondersteuning voor meerdere valuta&#39;s voor dynamiek**: Bizible past zich nu aan de valutatabellen van Microsoft Dynamics aan, zodat u eenvoudig kunt schakelen tussen zakelijke en lokale valuta&#39;s. (Opmerking: Ondersteuning voor SFDC is in het eerste kwartaal van 2019 uitgebracht.)
* **Drift Integration**: Begrijp hoe de gesprekken van de Drijving de reis van uw klant beïnvloeden. Bizible haalt ook e-mailadressen uit gesprekken om een nieuwe lead te maken of om het aanraakpunt aan een bestaande lead te koppelen.
...
***Webinar productrelease*** Bekijk de opname van ons webinar van de release Innovations van 19 juni [hier](https://engage.marketo.com/Marketo-June-Product-Release-2019-On-Demand.html).
