...
product: marketo
description: Meer informatie over de Designer e-mail en de bijbehorende slepen-en-neerzeteditor. Maak en pas e-mailsjablonen aan in Marketo Engage voor een betere productiviteit.
title: Overzicht
...
## Populaire artikelen {#popular-articles}
...
* [&#x200B; Beeld aan de omzetter van HTML &#x200B;](/help/marketo/product-docs/email-marketing/email-designer/feature-comparison.md){target="_blank"}: Upload een volgzaam PNG/JPEG beelddossier van een e-mail en het zal automatisch in HTML voor gebruik in nieuwe E-mail Designer worden omgezet.

* [&#x200B; Merk thema&#39;s &#x200B;](/help/marketo/product-docs/email-marketing/email-designer/brands/brand-themes.md){target="_blank"}: Bepaal merkthema&#39;s binnen Marketo Engage. Stijlconfiguraties kunnen opnieuw worden gebruikt en worden toegepast op e-mailsjablonen en andere e-mailmiddelen voor de consistentie van merken.

* [&#x200B; de importeur van het Malplaatje &#x200B;](/help/marketo/product-docs/email-marketing/email-designer/import-template.md){target="_blank"}: De malplaatjes van de invoer e-mail van de klassieke e-mailredacteur om malplaatjes tot stand te brengen compatibel met Nieuwe E-mail Designer in de Studio van het Ontwerp.

* [&#x200B; Voorwaardelijke inhoud &#x200B;](/help/marketo/product-docs/email-marketing/email-designer/conditional-content.md){target="_blank"}: De eigenschap van de pariteit voor nieuwe E-mail Designer, toestaand u om e-mailverpersoonlijking voorbij tokens te bereiken.
...
**zullen onze bestaande e-mailmalplaatjes in de nieuwe ontwerper werken?**

Ja, maar zij [&#x200B; moeten worden ingevoerd &#x200B;](/help/marketo/product-docs/email-marketing/email-designer/import-template.md).
...
Ja! Creeer en beheer uw merkrichtlijnen met [&#x200B; merkthema&#39;s &#x200B;](/help/marketo/product-docs/email-marketing/email-designer/brands/brand-themes.md).
...
Het is WYSIWYG; HTML-kennis is niet nodig. U kunt gemakkelijk malplaatjes in de ontwerper tot stand brengen, die de behoefte aan externe Webontwikkelaars verminderen. U kunt echter nog steeds CSS bijwerken en afzonderlijke secties bewerken via HTML.
