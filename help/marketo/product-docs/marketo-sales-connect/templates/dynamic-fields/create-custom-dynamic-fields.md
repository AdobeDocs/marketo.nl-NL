...
1. Volg het [normale CSV-uploadproces](http://docs.marketo.com/x/HIPS)en stop op het kaartscherm van het veld.
1. Kies in de vervolgkeuzelijst de optie **Een aangepast veld** toevoegen in plaats van een van de vooraf ingestelde velden.
