...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <tr>
   <td><strong> E-mail Designer - het Teruggeven van Vooruitzichten bevestigen </strong>: Deze update lost teruggevende kwesties, vooral in de Vooruitzichten van MS op. Met de geavanceerde HTML-modus kunt u kleine HTML/CSS-bewerkingen uitvoeren of scripttags toevoegen aan uw e-mailsjabloon.
   </td>
   <td>Vrijgegeven</td>
   <td><a href="/help/marketo/product-docs/email-marketing/email-designer/advanced-html-mode.md" target="_blank">E-mailsjablonen bewerken met de geavanceerde HTML-editor</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
