---
description: Veelgestelde vragen over Adobe Identity for Marketo Engage, waaronder migratie, URL's, productbeheer vs Marketo Admin, en op de lijst met gewenste personen zetten.
...
* Migratie vóór gebruiker: de gevallen van de dossiersteun in de [&#x200B; Gemeenschap van de Natie van de Marketing &#x200B;](https://nation.marketo.com/t5/support/ct-p/Support) of e-mail `marketocares@adobe.com`.

* De Migratie van de post-gebruiker: de gevallen van de dossiersteun in de [&#x200B; Gemeenschap van de Natie van de Marketing &#x200B;](https://nation.marketo.com/t5/support/ct-p/Support) of e-mail `marketocares@adobe.com`.
