...
1. In de **Database**, waar deze beschikbaar zijn voor gedeeld/wereldwijd gebruik (bijvoorbeeld &quot;Alle niet-geabonneerde personen&quot;).
1. In **programma&#39;s** als lokale activa, wanneer zij een groep personen vinden die relevant zijn voor dat specifieke programma (bijvoorbeeld &quot;Bijgewoonde handelswijze&quot;).
...
Hier kunt u [de naam van de slimme lijst bewerken](/help/marketo/product-docs/core-marketo-concepts/miscellaneous/rename-a-marketo-asset.md) en zie informatie over de slimme lijst.

![](assets/smartlist.png)

## Tab Personen {#people-tab}

Dit is waar u uw resultaten ziet; Alle personen die in aanmerking komen voor de filters die u wilt gebruiken [toegevoegd en gedefinieerd](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/find-and-add-filters-to-a-smart-list.md) onder het tabblad Slimme lijst.
