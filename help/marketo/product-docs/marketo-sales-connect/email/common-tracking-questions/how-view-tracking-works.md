...
* `Include an image` in uw e-mails (zoals een logo) zodat de ontvanger wordt aangeraden afbeeldingen uw bericht te laten zien.

* `Include a link` als een oproep tot actie in de e-mail.
