...
description: Meer informatie over de standaardtoewijzing van Salesforce-velden tussen Salesforce en Marketo Engage. Bekijk hoe de velden Leden, Contact, Account en Opportunity automatisch worden toegewezen.
title: Standaard Salesforce-veldtoewijzing
...
# Standaardveldtoewijzing [!DNL Salesforce] {#default-salesforce-field-mapping}

Wanneer u uw Marketo Engage-account voor het eerst synchroniseert met Salesforce, maakt Marketo automatisch deze koppelingen tussen uw ingebouwde Salesforce- en Marketo-velden. Marketo synchroniseert ook uw aangepaste velden op uw leads, accounts, opportunity en contactpersonen.
...
## [!DNL Salesforce] Verwante systeemvelden in Marketo (alleen-lezen) {#salesforce-related-system-fields-in-marketo-read-only}

Deze velden worden gemaakt in Marketo, maar kunnen niet worden aangepast door klanten.

| Veld | Beschrijving |
|---|---|
| SFDC-id | De id van 18 tekens [!DNL Salesforce] |
| SFDC-type | Lood of contactpersoon. Indien leeg, bestaat de lead alleen als een persoon in Marketo |
| Aanmaakdatum van SFDC | Datum gemaakt in SFDC (kan anders zijn dan Gemaakt in Marketo) |
