...
description: In Marketo Engage leert u meer over websegmenten en op het tabblad Segmenten ziet u alle aangepaste items. Gebruik deze handleiding om de volgende stap te voltooien.
title: Websegmenten
