...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td>Verzonden</td>
   <td><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/event-workflows#manual-sync">Handmatige synchronisatie</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
