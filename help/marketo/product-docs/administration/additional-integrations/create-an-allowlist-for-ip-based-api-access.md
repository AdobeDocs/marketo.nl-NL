...
>[!CAUTION]
>
>Het toelaten van deze eigenschap verhindert u tot de [&#x200B; Server MCP van Marketo &#x200B;](https://experienceleague.adobe.com/nl/docs/marketo-developer/marketo/mcp-server){target="_blank"} op dit ogenblik toegang te hebben. Dit probleem zal naar verwachting in een komende release worden opgelost.
