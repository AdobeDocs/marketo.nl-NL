---
description: Leer hoe u Marketo en Salesforce verbindt met OAuth 2.0. Stel een externe client-app in Salesforce in en geef Marketo toestemming om veilig te synchroniseren zonder referenties te delen.
