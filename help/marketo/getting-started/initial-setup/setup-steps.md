...
* **Marketo toevoegen aan uw bedrijfs-e-maillijst van gewenste personen**. Het is gebruikelijk om teste-mails naar uw testaccounts te sturen voordat u e-mails naar de werkelijke gebruikers stuurt. Als u Marketo voegt op lijst van gewenste personen, kunt u voorkomen dat deze teste-mails worden geblokkeerd of gemarkeerd als spam.
* **SPF en DKIM instellen**. Deze technologieën verzekeren uw ontvangers dat uw e-mails van Marketo geen spam zijn. Als u wilt voorkomen dat spamfilters van ontvangers u e-mails van Marketo weigeren, voert u de volgende stappen uit om [Een SPF en DKIM instellen voor uw e-maillevering](/help/marketo/product-docs/email-marketing/deliverability/set-up-spf-and-dkim-for-your-email-deliverability.md).
...
Ga naar de pagina **Beheerder** gebied.
...
>
>* [Gebruikersinstelling](/help/marketo/getting-started/initial-setup/user-setup.md)
