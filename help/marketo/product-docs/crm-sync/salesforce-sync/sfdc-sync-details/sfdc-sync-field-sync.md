...
description: Ontdek welke Salesforce-velden synchroniseren met Marketo en hoe SFDC Type en is verwijderd werken. Voeg eerst nieuwe velden in Salesforce toe, zodat ze automatisch worden gesynchroniseerd met Marketo.
