---
description: Opmerkingen bij de nieuwe release - Marketo Docs - Productdocumentatie
title: Opmerkingen bij de nieuwe release
hide: true
hidefromtoc: true
...
* **Upgrade naar Google Analytics 4**: RTP-gebruikers krijgen een unieke alfanumerieke tag (in het gedeelte `<head>` (in het html-gedeelte) op de bestemmingspagina&#39;s, zodat Marketo gegevens naar Google Analytics kan verzenden. Marketo heeft voorheen Universal Analytics gebruikt, die de gegevensregistratie voor 1 juli 2023 zal stopzetten. De gebruikers RTP zullen het migratieproces in hun dashboard van Google Analytics moeten volgen om de migratie te voltooien.

* **Upgrade naar jQuery 3.7**: Om de beveiliging en stabiliteit te verbeteren, voert Marketo een upgrade uit naar jQuery 3.7.0. RTP-gebruikers die zelf jQuery laden, kunnen negatieve gevolgen ondervinden als ze een versie gebruiken die ouder is dan 3.0.0. Deze gebruikers kunnen naar Marketo Support gaan voor hulp bij het implementeren van een specifieke versie van rtp.js die aan hun behoeften voldoet. Als u versie 3.0.0 of later gebruikt, zult u niet beïnvloed worden.
