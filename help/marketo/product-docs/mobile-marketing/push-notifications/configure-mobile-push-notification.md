---
description: Leer hoe u een mobiele pushmelding configureert. Stel de app, berichttekst, tikken op handelingen, diepe koppelingen in en geef uw goedkeuring voor verzending.
