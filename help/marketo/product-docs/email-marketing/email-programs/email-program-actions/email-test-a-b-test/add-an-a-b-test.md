...
description: Leer hoe u een A/B-test toevoegt aan een e-mailprogramma. Kies wat u wilt testen (onderwerp, inhoud, van of datum/tijd) en stel de criteria voor winnaars in.
...
1. Een nieuw venster opent met verschillende **Types van Test** om van te kiezen. Verken een van de verwante artikelen hieronder om door te gaan.
