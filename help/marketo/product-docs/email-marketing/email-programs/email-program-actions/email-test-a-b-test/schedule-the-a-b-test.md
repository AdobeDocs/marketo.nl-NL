...
1. Herhaal stappen 1 en 2 voor _verzendt Winner_. Voer (optioneel) ontvangers van een melding in en klik op **[!UICONTROL Next]** .
...
1. Controleer het overzicht en klik op **[!UICONTROL Close]** .
