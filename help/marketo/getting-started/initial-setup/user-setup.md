...
<tbody>
  <tr>
    ...
    <ul>
    <li>Contacteer het team van de Rekening van de Adobe (uw Manager van de Rekening) of verzend een e-mail naar <code>marketocares@marketo.com</code> om te weten te komen wie bij uw organisatie <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/adobe-identity-management-overview.html?lang=nl-NL"> Admin van het Systeem van Adobe Admin Console </a> voorrechten heeft.</li></ul>
    <li>Accepteer de uitnodiging 'Marketo Engage Product Admin' om uw Adobe ID te activeren. <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/admin-setup.html?lang=nl-NL#create-a-product-profile"> welkome e-mail </a> wordt verzonden wanneer de rol in Adobe Admin Console wordt toegewezen.</li></td>
  </tr>
  <tr>
    <td>Productprofielen</td>
    <td><li>Wijs alle gewenste gebruikers aan het Marketo Engage <a href="https://experienceleague.adobe.com/nl/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/admin-setup#create-a-product-profile"> Profiel van het Product </a> in Adobe Admin Console toe.</li>
    <ul>
  ...
  <tr>
    ...
    <li>Bepaal wie <a href="https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/adobe-identity-management-overview.html?lang=nl-NL"> Admin van het Systeem van de Adobe en de toestemmingen van Admin van het Product van de Marketo Engage zou moeten hebben.</a> <li><a href="https://experienceleague.adobe.com/nl/docs/marketo/using/product-docs/administration/marketo-with-adobe-identity/add-or-remove-a-user"> voeg gebruikers </a> aan het gewenste Profiel van het Product toe.</li>
    <li>Maak één API-gebruiker voor elke API-gebruikscase.</li></td>
  </tr>
  <tr>
    <td>Gebruikersbeheer-API (indien van toepassing)</td>
    <td><li>Gebruik het <a href="https://www.adobe.io/apis/experienceplatform/umapi-new.html"> Beheer API van de Gebruiker van de Adobe </a> om, gebruikers uit te nodigen bij te werken en te schrappen.</li>
    <li>Gebruik het <a href="https://developer.adobe.com/umapi/"> Beheer API van de Gebruiker van de Adobe </a> om rollen (b.v., Beheerders, Admins van de Steun, Ontwikkelaars) toe te voegen of te verwijderen.</li>
    </td>
  </tr>
  <tr>
    ...
    <li>Mogelijk hebt u van de systeembeheerder een e-mail ontvangen waarin u opgeeft dat u de beheerder van de ondersteuning voor uw abonnement op het Marketo Engage bent. Als zo, klik <a href="https://experienceleague.adobe.com/nl/docs/customer-one/using/home#assign-the-support-admin-role"> "krijgen Begonnen"</a> in e-mail om zich bij de organisatie aan te sluiten.</li>
...
Nu uw rekening van het Marketo Engage klaar is om te gaan, te herzien gelieve onze [ Beste praktijken voor een Nieuwe sectie van de Instantie van het Marketo Engage ](/help/marketo/getting-started/implementing-a-new-marketo-engage-instance/where-to-start.md){target="_blank"} om het meeste uit uw investering te krijgen en opstelling zelf voor langdurig succes.
