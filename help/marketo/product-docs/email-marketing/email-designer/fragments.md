...
product: marketo
title: Fragmenten
description: Leer hoe u fragmenten maakt en gebruikt als herbruikbare e-mailcomponenten. Voeg visuele inhoudsfragmenten toe aan e-mails en sjablonen.
...
1. Klik het _pictogram van Thema&#39;s_.
   ...
   >[!INFO]
   >
   >Leer meer over [ themamontages ](/help/marketo/product-docs/email-marketing/email-designer/brands/brand-themes.md#settings){target="_blank"}.
...
>[!NOTE]
>
>Als _Synchronisatie met HTML_ in e-mail wordt onbruikbaar gemaakt, zullen de aangebrachte veranderingen (met inbegrip van het breken overerving) niet in de tekstinhoud nadenken.
