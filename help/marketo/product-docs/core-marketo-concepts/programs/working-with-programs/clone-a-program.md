...
1. Voeg een optionele beschrijving toe en klik op **Maken**. Kijk hoe snel u een nieuw programma kon creëren met al zijn activa klaar om te gaan!
   ...
   >[!TIP]
   >
   >Gebruik deze techniek in combinatie met [tokens](http://docs.marketo.com/display/docs/using+tokens) om het maken van nieuwe programma&#39;s magnetisch te maken.
