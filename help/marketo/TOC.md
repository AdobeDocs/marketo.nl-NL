...
+ Aan de slag met Marketo Engage {#getting-started}
   ...
   + Informatie over dingen {#things-to-know}
      ...
      + [Abonneren op systeemstatusmeldingen](getting-started/things-to-know/system-status-notifications.md)
...
+ Productdocumenten {#product-docs}
   ...
   + Administratie {#administration}
      ...
      + Instellingen {#settings}
         ...
         + [Uw tijdzone wijzigen](product-docs/administration/settings/change-time-zone.md)
         + [Een terugvalpagina instellen](product-docs/administration/settings/set-a-fallback-page.md)
         + [De standaardvaluta instellen](product-docs/administration/settings/set-default-currency.md)
   ...
   + E-mailmarketing {#email-marketing}
      ...
      + Designer e-mailen {#email-designer}
         ...
         + [Voorwaardelijke inhoud](product-docs/email-marketing/email-designer/conditional-content.md)
         ...
         + [E-mailsjabloon geavanceerd HTML Editor](product-docs/email-marketing/email-designer/advanced-html-mode.md)
...
+ Aanvullende informatie {#release-notes}
   ...
   + Eerdere releases {#previous-releases}
      ...
      + 2025 {#2025}
         ...
         + [Opmerkingen bij de release: oktober &#39;25](release-notes/previous-releases/2025/release-notes-oct-25.md)
      + 2024 {#2024}
