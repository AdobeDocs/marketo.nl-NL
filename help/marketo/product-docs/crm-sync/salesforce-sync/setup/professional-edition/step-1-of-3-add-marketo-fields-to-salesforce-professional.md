...
# Stap 1 van 3: Marketo-velden toevoegen aan [!DNL Salesforce] (Professional) {#step-of-add-marketo-fields-to-salesforce-professional}

>[!PREREQUISITES]
>
>Uw Salesforce-exemplaar moet toegang hebben tot Salesforce API&#39;s om gegevens tussen Marketo Engage en Salesforce te synchroniseren.
...
Voer de volgende stappen uit voor elk van de drie aangepaste velden om deze toe te voegen. Begin met **[!UICONTROL Score]** .
...
1. Kies het aangewezen gebiedstype (voor Score - **[!UICONTROL number]**; Het Programma van de verwerving - **[!UICONTROL text]**; de Datum van de verwerving - **Datum/Tijd**).
...
1. Klik in het menu Build aan de linkerkant op **[!UICONTROL Customize]** en selecteer **[!UICONTROL Contacts]** . Klik op **[!UICONTROL Fields]**.
...
1. Typ &quot;[!UICONTROL fields]&quot; in de zoekopdracht Nav zonder op Enter te drukken. Velden worden onder verschillende objecten weergegeven. Klik op **[!UICONTROL Fields]** onder Leads.
