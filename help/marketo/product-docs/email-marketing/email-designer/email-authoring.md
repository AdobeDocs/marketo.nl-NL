...
>[!MORELIKETHIS]
>
>[ E-mailmalplaatjes ](/help/marketo/product-docs/email-marketing/email-designer/email-template.md){target="_blank"}: Leer hoe te om, tot een e-mailmalplaatje in de nieuwe ontwerper te leiden te ontwerpen en toegang te hebben.
