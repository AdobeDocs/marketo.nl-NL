...
description: Hoe te om een slechts API gebruikersrol voor integratie van REST API te creëren door een rolnaam te bepalen en de API toegangstoestemmingen te selecteren om te verlenen.
...
>[!MORELIKETHIS]
>
>Goed gedaan! Nu maak [&#x200B; een slechts gebruiker API &#x200B;](/help/marketo/product-docs/administration/users-and-roles/create-api-only-user.md).
