...
1. Lees de waarschuwing en klik vervolgens op **Credentials bevestigen**.
   ...
   >[!CAUTION]
   >
   >Als u over [afbeeldingen wilt kijken en hen ](https://docs.marketo.com/display/public/DOCS/Edit+Initial+Field+Mappings) wilt aanpassen, is dit uw enige kans om dit te doen! Als u eenmaal op Salesforce Sync starten hebt geklikt, is het gelukt.
