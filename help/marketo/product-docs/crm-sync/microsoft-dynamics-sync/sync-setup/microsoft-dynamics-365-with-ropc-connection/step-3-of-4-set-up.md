---
description: Leer hoe u de client-app instelt op de Microsoft Dynamics for ROPC-verbinding. Registreer de app in Azure AD en genereer een clientgeheim voor Marketo-synchronisatie.
