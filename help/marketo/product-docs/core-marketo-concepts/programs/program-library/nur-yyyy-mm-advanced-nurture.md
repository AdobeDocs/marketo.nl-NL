---
description: Sjabloon van geavanceerd cursusprogramma. Gebruik het voor multi-stroomkwekerij met een noemende overeenkomst.
...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   <td>Map</td>
   <td> </td>
   <td>Assets (bevat geneste programma's en mappen met middelen die ook in geneste programma's staan voor e-mails)</td>
  </tr>
  <tr>
   <td>Map</td>
   <td> </td>
   <td>Geneste programma's (leeft onder de map Assets)</td>
  </tr>
  <tr>
   <td>Map</td>
   <td> </td>
