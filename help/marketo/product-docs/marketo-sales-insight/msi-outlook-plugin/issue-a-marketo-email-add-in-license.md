...
1. Voer de e-mailadressen in van de verkopers die moeten worden geautoriseerd voor het gebruik van de plug-in en klik op **[!UICONTROL Issue License]** . Als u meerdere e-mailadressen wilt invoeren, scheidt u deze met een komma.

   ![](assets/image2016-8-31-9-3a37-3a8.png)

   >[!NOTE]
   >
   >* Om de stop ver te installeren, verlaat _verzendt e-mail van de Registratie met downloadverbinding_ checkbox ongecontroleerd en verzendt uw team van IT uw [&#x200B; Sleutel van de Onderneming &#x200B;](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-add-in-for-outlook-with-an-enterprise-key.md).
   >
   >* Als uw verkoopvertegenwoordigers beheerdertoegang tot hun computers hebben, controleer _verzendt e-mail van de Registratie met downloadverbinding_ checkbox en u wordt gedaan. De ontvangers hebben **30 dagen** om de verbinding in e-mail te klikken alvorens het verloopt.
